...
@Component({
  selector: 'app-formulario-wasticredit',
  standalone: true,
  imports: [CommonModule, FormsModule, HttpClientModule],
  templateUrl: './formulario-wasticredit.component.html',
  styleUrl: './formulario-wasticredit.component.css'
})
export class FormularioWasticreditComponent implements OnInit {
  solicitud: any = {
    nombre: '',
    apellidos: '',
    email: '',
  ...
  enviarSolicitud() {
    ...
    this.solicitudService.crearSolicitud(this.solicitud).subscribe({
      next: () => {
        this.solicitud = { nombre: '', apellidos: '', email: '', monto: '', fecha: '', comentario: '', puntuacion: null, simulador: 'wasticredit' };
        this.enviando = false;
        Swal.fire({
          icon: 'success',
