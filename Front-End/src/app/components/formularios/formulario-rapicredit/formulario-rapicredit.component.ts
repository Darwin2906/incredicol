...
@Component({
  selector: 'app-formulario-rapicredit',
  standalone: true,
  imports: [CommonModule, FormsModule, HttpClientModule],
  templateUrl: './formulario-rapicredit.component.html',
  styleUrl: './formulario-rapicredit.component.css'
})
export class FormularioRapicreditComponent implements OnInit {
  solicitud: any = {
    nombre: '',
    apellidos: '',
    email: '',
  ...
  enviarSolicitud() {
    ...
    this.solicitudService.crearSolicitud(this.solicitud).subscribe({
      next: () => {
        this.solicitud = { nombre: '', apellidos: '', email: '', monto: '', fecha: '', comentario: '', puntuacion: null, simulador: 'rapicredit' };
        this.enviando = false;
        Swal.fire({
          icon: 'success',
