...
@Component({
  selector: 'app-formulario-lineru',
  standalone: true,
  imports: [CommonModule, FormsModule, HttpClientModule],
  templateUrl: './formulario-lineru.component.html',
  styleUrl: './formulario-lineru.component.css'
})
export class FormularioLineruComponent implements OnInit {
  solicitud: any = {
    nombre: '',
    apellidos: '',
    email: '',
  ...
  enviarSolicitud() {
    ...
    this.solicitudService.crearSolicitud(this.solicitud).subscribe({
      next: () => {
        this.solicitud = { nombre: '', apellidos: '', email: '', monto: '', fecha: '', comentario: '', puntuacion: null, simulador: 'lineru' };
        this.enviando = false;
        Swal.fire({
          icon: 'success',
