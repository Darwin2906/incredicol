...
@Component({
  selector: 'app-formulario-solventa',
  standalone: true,
  imports: [CommonModule, FormsModule, HttpClientModule],
  templateUrl: './formulario-solventa.component.html',
  styleUrl: './formulario-solventa.component.css'
})
export class FormularioSolventaComponent implements OnInit {
  solicitud: any = {
    nombre: '',
    apellidos: '',
    email: '',
  ...
  enviarSolicitud() {
    ...
    this.solicitudService.crearSolicitud(this.solicitud).subscribe({
      next: () => {
        this.solicitud = { nombre: '', apellidos: '', email: '', monto: '', fecha: '', comentario: '', puntuacion: null, simulador: 'solventa' };
        this.enviando = false;
        Swal.fire({
          icon: 'success',
