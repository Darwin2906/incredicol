...
@Component({
  selector: 'app-formulario-prestanza',
  standalone: true,
  imports: [CommonModule, FormsModule, HttpClientModule],
  templateUrl: './formulario-prestanza.component.html',
  styleUrl: './formulario-prestanza.component.css'
})
export class FormularioPrestanzaComponent implements OnInit {
  solicitud: any = {
    nombre: '',
    apellidos: '',
    email: '',
  ...
  enviarSolicitud() {
    ...
    this.solicitudService.crearSolicitud(this.solicitud).subscribe({
      next: () => {
        this.solicitud = { nombre: '', apellidos: '', email: '', monto: '', fecha: '', comentario: '', puntuacion: null, simulador: 'prestanza' };
        this.enviando = false;
        Swal.fire({
          icon: 'success',
