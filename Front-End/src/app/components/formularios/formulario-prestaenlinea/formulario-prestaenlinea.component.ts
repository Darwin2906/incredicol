...
@Component({
  selector: 'app-formulario-prestaenlinea',
  standalone: true,
  imports: [CommonModule, FormsModule, HttpClientModule],
  templateUrl: './formulario-prestaenlinea.component.html',
  styleUrl: './formulario-prestaenlinea.component.css'
})
export class FormularioPrestaenlineaComponent implements OnInit {
  solicitud: any = {
    nombre: '',
    apellidos: '',
    email: '',
  ...
  enviarSolicitud() {
    ...
    this.solicitudService.crearSolicitud(this.solicitud).subscribe({
      next: () => {
        this.solicitud = { nombre: '', apellidos: '', email: '', monto: '', fecha: '', comentario: '', puntuacion: null, simulador: 'prestaenlinea' };
        this.enviando = false;
        Swal.fire({
          icon: 'success',
