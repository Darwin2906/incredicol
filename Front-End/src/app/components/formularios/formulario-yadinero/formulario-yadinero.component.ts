...
@Component({
  selector: 'app-formulario-yadinero',
  standalone: true,
  imports: [CommonModule, FormsModule, HttpClientModule],
  templateUrl: './formulario-yadinero.component.html',
  styleUrl: './formulario-yadinero.component.css'
})
export class FormularioYadineroComponent implements OnInit {
  solicitud: any = {
    nombre: '',
    apellidos: '',
    email: '',
  ...
  enviarSolicitud() {
    ...
    this.solicitudService.crearSolicitud(this.solicitud).subscribe({
      next: () => {
        this.solicitud = { nombre: '', apellidos: '', email: '', monto: '', fecha: '', comentario: '', puntuacion: null, simulador: 'yadinero' };
        this.enviando = false;
        Swal.fire({
          icon: 'success',
