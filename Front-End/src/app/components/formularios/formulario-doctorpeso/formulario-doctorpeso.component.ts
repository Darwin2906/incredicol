...
@Component({
  selector: 'app-formulario-doctorpeso',
  standalone: true,
  imports: [CommonModule, FormsModule, HttpClientModule],
  templateUrl: './formulario-doctorpeso.component.html',
  styleUrl: './formulario-doctorpeso.component.css'
})
export class FormularioDoctorpesoComponent implements OnInit {
  solicitud: any = {
    nombre: '',
    apellidos: '',
    email: '',
  ...
  // Lógica para estrellas y medias estrellas
  ...
  enviarSolicitud() {
    ...
    this.solicitudService.crearSolicitud(this.solicitud).subscribe({
      next: () => {
        this.solicitud = { nombre: '', apellidos: '', email: '', monto: '', fecha: '', comentario: '', puntuacion: null, simulador: 'doctorpeso' };
        this.enviando = false;
        Swal.fire({
          icon: 'success',
