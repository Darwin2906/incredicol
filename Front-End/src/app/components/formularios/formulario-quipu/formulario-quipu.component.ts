...
@Component({
  selector: 'app-formulario-quipu',
  standalone: true,
  imports: [CommonModule, FormsModule, HttpClientModule],
  templateUrl: './formulario-quipu.component.html',
  styleUrl: './formulario-quipu.component.css'
})
export class FormularioQuipuComponent implements OnInit {
  solicitud: any = {
    nombre: '',
    apellidos: '',
    email: '',
  ...
  enviarSolicitud() {
    ...
    this.solicitudService.crearSolicitud(this.solicitud).subscribe({
      next: () => {
        this.solicitud = { nombre: '', apellidos: '', email: '', monto: '', fecha: '', comentario: '', puntuacion: null, simulador: 'quipu' };
        this.enviando = false;
        Swal.fire({
          icon: 'success',
